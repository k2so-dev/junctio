...
<template>
  <div class="flex min-h-0 flex-1 flex-col gap-4 overflow-auto p-6">
    <PageHeader
      title="Explore"
      description="Servers published to the official MCP registry. The gateway asks for this list only while you are on this page, and keeps the answer for an hour."
    >
      <template #actions>
    ...
    <EmptyState
      v-if="failure"
      dashed
      title="The registry is out of reach"
      :description="failure"
    >
